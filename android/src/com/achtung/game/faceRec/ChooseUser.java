...
public class ChooseUser extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final MainFaceRecActivity faceRecog = new MainFaceRecActivity();
		...
		gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				{
					Intent intent = new Intent(ChooseUser.this, AddNewUser.class);
...
//		getMenuInflater().inflate(R.menu.choose_user, menu);
	...
	private void saveAlbum() {
		albumBuffer = MainFaceRecActivity.faceObj
