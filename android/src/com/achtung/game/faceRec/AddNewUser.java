...
/**
 * Created by Zlash on 23/02/16.
 */


public class AddNewUser extends Activity implements Camera.PreviewCallback {
...
//        vibrate = (Vibrator) com.mygdx.game.AddNewUser.this
//                .getSystemService(Context.VIBRATOR_SERVICE);
        ...
        animationFadeOut = AnimationUtils.loadAnimation(AddNewUser.this,
...
//                vibrate.vibrate(80);
    ...
    /*
     * Action listener method for the camera shutter button.
     */
...
//                vibrate.vibrate(80);
    ...
    /*
     * Action listener method for the settings button.
     */
    ...
    private void startCamera() {
        ...
        mPreview = new CameraSurfacePreview(AddNewUser.this, cameraObj,
                orientationListener); // Create a new surface on which Camera
        // will be displayed.
        preview = (FrameLayout) findViewById(R.id.cameraDisplay);
        preview.addView(mPreview);
        cameraObj.setPreviewCallback(AddNewUser.this);
    }
            ...
            case 0:
                if (finalResultCode == RESULT_OK) {
                    ...
                    if (bitmap != null) {
                        ...
                        Intent in1 = new Intent(AddNewUser.this,
                                ImageConfirmation.class);
                        in1.putExtra(
                                "com.qualcomm.sdk.recognition.sample.com.mygdx.game.ImageConfirmation",
                                byteArray);
                        in1.putExtra(
                                "com.qualcomm.sdk.recognition.sample.com.mygdx.game.ImageConfirmation.switchCamera",
                                true);
                        in1.putExtra(
                                "com.qualcomm.sdk.recognition.sample.com.mygdx.game.ImageConfirmation.through.gallery",
                                true);
                        in1.putExtra(
                                "com.qualcomm.sdk.recognition.sample.com.mygdx.game.ImageConfirmation.orientation",
                                0);
